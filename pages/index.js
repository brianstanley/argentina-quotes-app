      ...
      <div className="flex justify-between">
        <div>
          <h1 className="text-4xl font-bold text-indigo-900 mt-">
            Hi welcome to my Code Challenge for Pluggy.ai
          </h1>
        </div>
      </div>
      <div>
          ...
          <div className="py-4 px-8 bg-white shadow-lg rounded-lg ">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600">
                Hi everyone! I built this challenge Using NextJS + React. I
                deployed to Vercel in order to serve the API endpoints as
                Serverless Functions. Hope you enjoy it!.
              </p>
            </div>
